package com.fs.domain.util;

import com.fs.common.core.exception.FsCommonException;
import com.fs.domain.common.CodeEnumModel;
import com.fs.domain.common.EnumModel;
...
public class EnumUtils {
    public static <E extends CodeEnumModel> E getEnum(Object value, Class<E> enumClass) {
        if (value instanceof Integer) {
            ...
            throw new FsCommonException("WRONG ENUM VALUE: "+value+" IS MUST BE STRING OR INTEGER");
        }
    }
